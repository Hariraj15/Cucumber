...
public class CustomerSteps {
	...
	public void user_should_enter_all_the_fields_with_valid_data() {
		...
		w.findElement(By.id("fname")).sendKeys("Hari");
		w.findElement(By.id("lname")).sendKeys("Raj");
		w.findElement(By.id("email")).sendKeys("hariraj.mv@gmail.com");
		w.findElement(By.xpath("//textarea[@name='addr']")).sendKeys("Medavakkam Chennai");
		w.findElement(By.id("telephoneno")).sendKeys("9894730181");
